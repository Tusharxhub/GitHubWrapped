...
export default function Home() {
  ...
  const handleGitHubClick = useCallback(() => {
    ...
    window.open("https://github.com/Tushardevx01/GitHubWrapped", "_blank");
  }, [op]);

  const handleShareOnX = useCallback(() => {
    op.track("share_on_x", { location: "home" });
    window.open(
      `https://twitter.com/intent/tweet?text=Create your GitHub Wrapped for ${YEAR}!%20%23GitHubWrapped&url=https://githubwrapped01.vercel.app/`,
      "_blank"
    );
  }, [op]);
